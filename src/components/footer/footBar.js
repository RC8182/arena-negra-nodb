...
export default function FootBar({idioma,  border_color}) {
  return (
    <div className={`bg-black fixed bottom-0 w-full h-12 border-t-2 ${border_color} rounded-t-lg overflow-hidden md:hidden`}>
